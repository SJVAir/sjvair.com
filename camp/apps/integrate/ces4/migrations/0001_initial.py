# Generated by Django 4.2.20 on 2025-07-09 22:49
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('tract', models.CharField(help_text='Given Tract GEOID from the 2010 Census', max_length=12, null=True, verbose_name='Tract GEOID')),
                ...
                ('ci_score_p', models.FloatField(null=True, verbose_name='CalEnviroScreen Score Percentile')),
                ...
                ('pol_ozone', models.FloatField(help_text='Amount of daily maximum 8 hour Ozone concentration', null=True, verbose_name='Ozone Concentration')),
                ('pol_ozone_p', models.FloatField(null=True, verbose_name='Ozone Concentration Percentile')),
                ('pol_pm', models.FloatField(help_text='Annual mean PM2.5 concentrations', null=True, verbose_name='PM2.5 Concentration')),
                ('pol_pm_p', models.FloatField(null=True, verbose_name='PM2.5 Concentration Percentile')),
                ('pol_diesel', models.FloatField(help_text='Diesel PM emissions from on-road and non-road sources', null=True, verbose_name='Diesel PM emissions')),
                ('pol_diesel_p', models.FloatField(null=True, verbose_name='Diesel PM emissions Percentile')),
                ('pol_pest', models.FloatField(help_text='Total pounds of selected active pesticide ingredients', null=True, verbose_name='Pesticides')),
                ('pol_pest_p', models.FloatField(null=True, verbose_name='Pesticides Percentile')),
                ('pol_rsei_haz', models.FloatField(help_text='Toxicity-weighted concentrations of modeled chemical releases to air from facility emissions and off-site incineration', null=True, verbose_name='Chemical Releases')),
                ('pol_rsei_haz_p', models.FloatField(null=True, verbose_name='Chemical Releases Percentile')),
                ('pol_traffic', models.FloatField(help_text='Traffic density in vehicle-kilometers per hour per road length, within 150 meters of the census tract boundary', null=True, verbose_name='Traffic')),
                ('pol_traffic_p', models.FloatField(null=True, verbose_name='Traffic Percentile')),
                ('pol_drink', models.FloatField(help_text='Drinking water contaminant index for selected contaminants', null=True, verbose_name='Drinking Water Contaminant')),
                ('pol_drink_p', models.FloatField(null=True, verbose_name='Drinking Water Contaminant Percentile')),
                ('pol_haz', models.IntegerField(help_text='Sum of weighted hazardous waste facilities and large quantity generators within buffered distances to populated blocks of census tracts', null=True, verbose_name='Hazardous Waste Facilities')),
                ('pol_haz_p', models.FloatField(null=True, verbose_name='Hazardous Waste Facilities Percentile')),
                ('pol_lead', models.FloatField(help_text='Potential risk for lead exposure in children living in low-income communities with older housing', null=True, verbose_name='Lead Exposure')),
                ...
                ('pol_iwb', models.IntegerField(help_text='Sum of number of pollutants across all impaired water bodies within buffered distances to populated blocks of census tracts', null=True, verbose_name='Impaired Water Bodies')),
                ...
                ('char_asthma', models.FloatField(help_text='Age-adjusted rate of emergency department visits for asthma', null=True, verbose_name='Asthma Emergencies')),
                ('char_asthma_p', models.FloatField(null=True, verbose_name='Asthma Emergencies Percentile')),
                ('char_cvd', models.FloatField(help_text='Age-adjusted rate of emergency department visits for heart attacks per 10,000', null=True, verbose_name='Heart Attack Emergencies')),
                ...
                ('county', models.CharField(choices=[('fresno', 'Fresno'), ('kern', 'Kern'), ('kings', 'Kings'), ('madera', 'Madera'), ('merced', 'Merced'), ('san joaquin', 'San Joaquin'), ('stanislaus', 'Stanislaus'), ('tulare', 'Tulare')], default=None, help_text='County this tract is in according to fips number', verbose_name='San Joaquin Valley County')),
                ('geometry', django.contrib.gis.db.models.fields.GeometryField(help_text='Geometric shape of this tract', srid=4326, verbose_name='Tract Shape')),
            ],
        ),
    ]
