# Generated by Django 4.2.14 on 2025-04-09 00:44
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('location', models.CharField(choices=[('inside', 'inside'), ('outside', 'outside')], max_length=10)),
                ('sensor', models.CharField(blank=True, db_index=True, default='', max_length=50)),
                ('calibration', models.CharField(db_index=True, max_length=50, null=True)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(fields=('monitor', 'timestamp', 'sensor', 'calibration'), name='unique_calibrated_entry_temperature'),
        ),
        migrations.AddIndex(
            model_name='so2',
        ...
        migrations.AddConstraint(
            model_name='so2',
            constraint=models.UniqueConstraint(fields=('monitor', 'timestamp', 'sensor'), name='unique_entry_so2'),
        ),
        migrations.AddIndex(
            model_name='pressure',
        ...
        migrations.AddConstraint(
            model_name='pm25',
            constraint=models.UniqueConstraint(fields=('monitor', 'timestamp', 'sensor', 'calibration'), name='unique_calibrated_entry_pm25'),
        ),
        migrations.AddIndex(
            model_name='pm100',
        ...
        migrations.AddConstraint(
            model_name='humidity',
            constraint=models.UniqueConstraint(fields=('monitor', 'timestamp', 'sensor', 'calibration'), name='unique_calibrated_entry_humidity'),
        ),
        migrations.AddIndex(
            model_name='co',
