# Generated by Django 4.2.11 on 2024-06-28 10:58
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('status', model_utils.fields.StatusField(choices=[('draft', 'draft'), ('published', 'published')], db_index=True, default='draft', max_length=100, no_check_for_status=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('synonyms', django_jsonform.models.fields.ArrayField(base_field=models.CharField(max_length=100), blank=True, size=None)),
