...
class Command(BaseCommand):
    ...
    def handle(self, *args, **options):
        ...
        criteria_url = f'{BASE_URL}/faccrit_output.csv?dbyr={year}&co_={county}'
        toxics_url = f'{BASE_URL}/factox_output.csv?dbyr={year}&co_={county}'
        ...
        batch_results = [point for _, point in geocode.census_batch(rows)]
